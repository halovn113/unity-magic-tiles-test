...
public class TileManager : MonoBehaviour, IObservable<TileTouchingData>
{
    ...
    public void OnAwake(TileTouchingObserver tileTouchingObserver, ObserverManager observerManager)
    {
    ...
    public void SpawnTile()
    {
        ...
        List<Vector3> listAvailablePositions = new List<Vector3>(listSpawnPositions);
